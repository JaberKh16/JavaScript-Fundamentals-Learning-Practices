/*
    ...
    =========================================
    array.lastIndexOf(element) method is used to find out the
    index of the specified 'element' passed as argument from 
    an array. If found returns the index value, otherwise 
    returns -1.
    ...
    lastIndexOf(element) doesn't change the original array.
*/
