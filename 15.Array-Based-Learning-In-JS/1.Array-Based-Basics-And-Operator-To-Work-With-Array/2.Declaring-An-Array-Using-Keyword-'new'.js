/*
    ...
    =======================
    In JS, Array is basically a list of elements which can be either homegeneous type or
    non-homogeneous type also. Array is basically used to store multiple values
    at a time.
...
let numbersList = new Array(1, 2, 4, 5, 6, 8, 9, 0);
...
// Problem with array declaring this way - better to avoid this way 
let arr = new Array(10); // it will create an array with length 10 having empty items
console.log(arr);