/*
    ...
    ============================================
    Array.isArray(value) function is introduce by ES6 which
    is used get the type of a value means it determine whether if 
    a value is an array or not and resulted as boolean value.
