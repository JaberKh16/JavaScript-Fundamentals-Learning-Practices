...
h2Element.className = 'changeFontSizeProperty'; // changing the CSS Class Propery 'changeFontSizeProperty'
                                                // this will overwrites the previous class property styling
