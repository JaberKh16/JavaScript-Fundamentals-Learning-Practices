...
console.log(h2Element.className); // checking it will return the class name value as a string
console.log(`Type is: ${typeof h2Element.className}`); // checking type of output