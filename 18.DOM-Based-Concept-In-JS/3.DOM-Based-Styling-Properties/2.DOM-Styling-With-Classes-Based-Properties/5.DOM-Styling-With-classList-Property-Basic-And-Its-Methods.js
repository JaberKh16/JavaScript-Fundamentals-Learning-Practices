/*
    ...
    In the code above, lets demonstrate it in the following-
        ...
        some_method()   --> here, 'some_method()' is the classList property based methods
...
h2Element.classList.add('changeBackgroundProperty'); // adding the 'changeBackgroundProperty' class property in the DOMTokenList

console.log(h2Element.classList); // checking it will return the class name value as a string
console.log(`Type is : ${typeof h2Element.classList}`); // checking type of output

// defining a function to add another class property in the DOMTokenList Object
function addingChangeFontSizeProperty(h2Element){ // using named function concept
    h2Element.classList.add('changeFontSizeProperty'); // adding the 'changeFontSizeProperty' class property
};

addingChangeFontSizeProperty(h2Element);

// defining a function to remove a single class property from the DOMTokenList Object
const removedClassProperty = function(h2Element){ // using anynomus function concept
    h2Element.classList.remove('changeFontSizeProperty');
}

removedClassProperty(h2Element);


// defining a function to toggle a single class property to the DOMTokenList Object
(function (h2Element){ // using self invoking function concept
    h2Element.classList.toggle('changeDefaultBorderProperty'); // though this class is not exist in the DOMTokenList Object,so will be added
})(h2Element);