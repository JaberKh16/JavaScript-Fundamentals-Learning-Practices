/*
    ...
    ====================================
    str.lastIndexOf('substr') is used to search for the index of the
    substring that returns the last occurence of index value of that 
    specified substring.
...
let message_y = message1.lastIndexOf("is"); // returns the index value 
...
let msg_first_occ = message2.lastIndexOf("is"); // retuns on the last occurence index of the specified 'substr'
...
let sub_not_found = message3.lastIndexOf("gthis"); // returns -1 though not found specified 'substr'
